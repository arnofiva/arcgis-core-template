import{jd as y,je as T,jf as $,a$ as p,jg as c,jh as A,ji as I,jj as O,jk as S,jl as n,jm as v,jn as b,jo as d,jp as x,ax as C,jq as D,jr as E,ah as r,js as o,jt as P,ju as w,jv as N,jw as R,jx as L,jy as V,jz as F,jA as M,jB as U,jC as B,jD as z,jE as G,jF as H,jG as W,jH as Q,jI as k,jJ as q,jK as u,jL as J,jM as K,jN as X,jO as Y,jP as Z,jQ as ee,jR as te,jS as se}from"./index-bed22865.js";function ae(t){const e=new y,{vertex:s,fragment:a}=e;return T(s,t),e.include($,t),e.attributes.add(p.POSITION,"vec3"),e.attributes.add(p.UV0,"vec2"),t.perspectiveInterpolation&&e.attributes.add(p.PERSPECTIVEDIVIDE,"float"),e.varyings.add("vpos","vec3"),t.multipassEnabled&&e.varyings.add("depth","float"),s.code.add(c`
    void main(void) {
      vpos = position;
